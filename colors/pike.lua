...
local c = vim.o.background == "light"
		and {
			...
			fg_statusline = p.gray_70,
			bg_statusline = p.gray_10,
			fg_linenr = p.gray_50,
			fg_cursorlinenr = p.gray_70,
			fg_nontext = p.gray_40,
			fg_unnecessary = p.gray_40,
			fg_comment = p.gray_60,
			fg_error = p.red_60,
			fg_warn = p.yellow_60,
			fg_info = p.cyan_70,
			fg_hint = p.blue_70,
	...
	or {
		...
		bg_cursearch = p.yellow_30,
		fg_cursearch = p.black,
		fg_statusline = p.gray_30,
		bg_statusline = p.gray_100,
		fg_linenr = p.gray_60,
		fg_cursorlinenr = p.gray_70,
		fg_nontext = p.gray_70,
		fg_unnecessary = p.gray_70,
		fg_comment = p.gray_60,
		fg_error = p.red_40,
		fg_warn = p.yellow_40,
		fg_info = p.cyan_40,
