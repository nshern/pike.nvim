...
vim.api.nvim_set_hl(0, "DiagnosticInfo", { fg = palette.teal_40 })
...
vim.api.nvim_set_hl(0, "Changed", { fg = palette.teal_30 })
vim.api.nvim_set_hl(0, "Added", { fg = palette.green_30 })
vim.api.nvim_set_hl(0, "Removed", { fg = palette.red_30 })
